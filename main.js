(function ($) {
	...
	class Silence {
		...
		buildCustomElements() {
			...
			$title.html($title.html().replace(`Devin_Lu | ${autherName}`, `${blogTitle}`));
			...
			$("#Header1_HeaderTitle").empty();
			$("#navList").append('<li><a id="blog_nav_myyoulian" class="menu" href="">友链</a><i></i></li><li><a id="blog_nav_myzanshang" class="menu" href="https://www.cnblogs.com/zouwangblog/articles/11340077.html">赞赏</a><i></i></li><li><a id="blog_nav_myguanyu" class="menu" href="">关于</a><i></i></li>');
			//添加标签icon
		...
		buildBloggerProfile() {
			...
			var title = '<div class="site-branding">' +
					...
					'<a href="https://www.cnblogs.com/devin-lu/" alt="Devin_Lu">' +
					'<ruby><span class="sakuraso">Devin_Lu</span><span class="no">の</span><span class="shironeko">雪</span>' +
